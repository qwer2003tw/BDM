...
public final class Task3 {
    ...
    private static final Pattern NUMBERS = Pattern.compile("^(\\d+[A-Za-z]+)\\s");
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, Map<String, Integer>> pairs = lines
                ...
                .mapToPair(s -> {
                    ...
                    words[3]=words[3].replaceAll("^(\\d+[A-Za-z]+)\\s","");
                    return new Tuple2<>(words[5], new Tuple2<>(words[3], 1));
                })
                .groupByKey()
                .mapValues(iters -> {
